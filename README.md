...
- Загрузка PDF-скана → нарезка страниц → vision-LLM черновик HTML (ProxyAPI: Gemini / OpenAI)
...
Требования: **Python 3.12+**, ключ [ProxyAPI](https://proxyapi.ru) (для перевода страниц).
...
cp .env.example .env
# отредактируйте JWT_SECRET и OPENAI_API_KEY
