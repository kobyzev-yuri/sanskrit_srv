...
- Загрузка PDF-скана → нарезка страниц → vision-LLM черновик HTML (по умолчанию Gemini 3.1 Pro через Google AI Studio; запасные OpenRouter / Opus через ProxyAPI)
