...
| **Слить эту шлоку** | Только перевод **и выбранный голос**: поле под каждым русским абзацем — вставить вариант профессора и слить с черновиком Gemini |
...
На странице перевода при **выбранном голосе** у каждого русского абзаца (шлока, заголовок, строка комментария) появляется **пустое зелёное поле**. Без голоса («Голос: нет») поля слияния скрыты. Туда вставляют второй вариант — обычно перевод профессора. Кнопка **Слить эту шлоку** собирает гибрид с текущим черновиком (часто Gemini) и подменяет **только эту** русскую строку.
...
1. Выберите голос в полосе шаблона. Страница **на правке**.
