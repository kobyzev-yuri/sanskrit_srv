...
| Панель **Скан** / **Санскрит** | слева | Оцифровка: страница PDF. Перевод: выверенный санскрит |
...
**Перевод на русский:** три колонки — слева выверенный санскрит, в центре превью/текст/HTML перевода и кнопки сохранить/согласовать, справа **Задание** (агент, смысловая проверка) и **Справочник**.

| Слева | Центр (перевод) / справа (оцифровка) | Справа (перевод) |
|-------|--------------------------------------|------------------|
| **Скан** или **Санскрит** | Вкладки **Превью** / **Текст** / **HTML** | **Задание** и **Справочник** |
...
4. **Применить выбранные**. Правка санскрита с меткой «слева» меняет и левую колонку.
