...
- Свои ключи: Timeweb AI Gateway (ключ + модель из списка со зрением) и/или ProxyAPI. Сеть, если не бэкофис, выбирается рядом. Модель ProxyAPI задаётся в бэкофисе, блок «Маршрут LLM».
