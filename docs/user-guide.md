...
Симптом: на скане **गणपतिगुंँ** или **ऋतग्ं** (полуформа **ग्** + анусвара), в черновике **गणपतिं** / **ऋतं** — модель подставила «словарную» анусвару. **गुंँ** и **ग्ं** — разные написания «гум», не унифицировать.
