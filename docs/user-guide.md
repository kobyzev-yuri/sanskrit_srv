...
| **Слить переводы** | Только перевод: вставить второй вариант (профессор / другая модель), даже одну шлоку; модель соберёт гибрид с текущим черновиком |
...
2. В поле **Второй перевод** вставьте текст профессора (можно без HTML, можно одну шлоку с ॥ n ॥).
