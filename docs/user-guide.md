...
| Поиск | **Найти в черновике** (Ctrl+F) | Подстрока по HTML-черновикам всей книги (в проекте перевода — ещё и по санскриту слева). Клик по результату открывает страницу и подсвечивает совпадения. Esc — сбросить |
