...
На проекте **перевода на русский** вместо них две кнопки:

| Кнопка | Результат |
|--------|-----------|
| **PDF перевода** | Книга: санскритские строки + русский перевод (как в превью) |
| **XLSX перевода** | Таблица Excel: страница · санскрит · русский (по блокам шлока / строка) |
