...
2. Под каждым русским абзацем шлоки — пустое зелёное поле. Вставьте туда перевод профессора **этой** шлоки.
3. **Слить эту шлоку**. Модель не выбирает целиком A или B: берёт грамматику и термины более точного варианта и оставляет читаемую русскую фразу в формате шаблона. Остальные шлоки на странице не трогает.
