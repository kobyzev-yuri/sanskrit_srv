...
- Свои ключи: OpenRouter (ключ + id модели вручную, без каталога; ox-alpha снят) и/или ProxyAPI. Сеть, если не бэкофис, выбирается рядом. Модель ProxyAPI задаётся в бэкофисе, блок «Маршрут LLM».
...
**Перевод и IAST:** три колонки — слева выверенный санскрит (**Превью** / **HTML**), в центре черновик и кнопки сохранить/согласовать, справа **Задание** и **Справочник**. Правка санскрита слева копируется в оцифровку: сначала снимок текущего HTML, затем новая версия. Если страница оцифровки была согласована, согласие снимается.
...
6. Правка IAST справа — только IAST. Правка санскрита слева уходит в оцифровку новой версией.
7. **Скачать PDF** / **Скачать DOCX**.
